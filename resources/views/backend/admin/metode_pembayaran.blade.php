            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($metode as $index=>$metodes)
                                <tr>
                                    <td>{{ $metodes->id }}</td>
                                    <td>{{ $metodes->metode }}</td>
                                    <td style="width: 20%"><img src="logo_metode_pembayaran/{{$metodes->logo }}" width="20%"></td>
                                     <td> 
                                        <button type="button" value="{{ $metodes->id }}" class="btn btn-primary editBtnMetode btn-sm">Edit</button>
                                        <a href="#" class = "btn btn-danger btn-sm delete" metode-id = "{{$metodes->id}}">Hapus
                                        </a>
                                    </td>
                            </tr>
                            @endforeach
...
<!-- /.content-wrapper -->
<div class="modal fade" id="tambaMetode" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{route('backend_admin_save_metode_pembayaran')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group{{$errors->has('kategori') ? 'has-error' : ''}}">
                        <label for="exampleInputEmail1">Metode Pembayaran</label>
                        <input name="metode" type="text" class="form-control" id="exampleInputEmail1"
...
<div class="modal fade" id="editBtnMetodeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route('update_backend_admin_metode_pembayaran') }}" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input name="metode" id="metode" type="text" class="form-control">
                    </div>
                    <div class="form-group">

...
@section('title','Laporan Jumlah Produk')
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active " href="{{route('superadmin_laporan_jumlah_produk')}}" >
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Laporan Jumlah Produk</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('superadmin')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Jumlah Produk</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Laporan Jumlah Produk</h3>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{route('superadmin_cetak_cetak_laporan_jumlah_produk')}}" class="float-right">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><small><b>Statu</b></small> </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($laporan_jumlah_produk as $index=>$datas)
                                <tr>

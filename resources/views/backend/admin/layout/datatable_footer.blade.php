...
<script>
    $(document).ready( function () {
        $('#datatable').DataTable();
        $('.delete').click(function(){
            var metode_id = $(this).attr('metode-id');
            swal({
                title: "Yakin ?",
                text: "Menghapus Data ?",
                icon: "warning",
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/hapus_backend_admin_metode_pembayaran/"+metode_id;
                }
            });
        });
    });
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.editBtnMetode', function () {
            var data_id = $(this).val();
            $('#editBtnMetodeModal').modal('show');
            $.ajax({
                type: "GET",
                ...
                success: function (response) {
                    //console.log(response.data.status);
                    $('#id').val(data_id);
                    $('#metode').val(response.data.metode);

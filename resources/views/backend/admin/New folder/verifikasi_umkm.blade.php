                                ...
                                <tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        <div class="form-group">
                                                            Syarat
                                                            <br>
                                                            <a href="syarat-03/{{ $datas->syarat_03 }}"
                                                                download>Syarat 3</a>
                                    ...
                                    <td>
                                        <button type="button" value="{{ $datas->id }}"
                                            class="btn btn-info syaratBtn btn-sm">Syarat</button>
                                    </td>
                                    <td></td>
                                    <td>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="update_backend_admin_verifikasi_umkm" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <input name="id" id="id" type="hidden" class="form-control">

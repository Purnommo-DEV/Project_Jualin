                ...
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        <tr>
                            ...
                            <td width="15%" class="qty" data-title="Qty"><!-- Input Order -->
                                ...
                                <input type="text" class="span1" name="kuantitas" data-min="1" data-max="{{$keranjangs->total_stok}}" style="max-width: 30px; text-align:center" value="{{$keranjangs->kuantitas}}">

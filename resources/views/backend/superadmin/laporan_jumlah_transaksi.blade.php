...
@section('title','Laporan Jumlah Transaksi')
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active " href="{{route('superadmin_laporan_jumlah_transaksi')}}" >
                               <i class="far fa-clipboard m-1"></i>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Laporan Jumlah Transaksi</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('superadmin')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Jumlah Transaksi</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Laporan Jumlah Transaksi</h3>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{route('superadmin_cetak_cetak_laporan_jumlah_transaksi')}}" class="float-right">
                        ...
                        <tbody>
                            @foreach($laporan_jumlah_transaksi as $index=>$datas)
                                <tr>

                                    <td>{{ $index+1 }}</td>
                                    <td>{{ $datas->nama_produk }}</td>
                                    <td>{{ $datas->umkm }}</td>
                                    <td>{{ $datas->total_beli }}</td>
                                    <td>{{ $datas->total_pendapatan }}</td>
                            </tr>
                            @endforeach
                        </tbody>

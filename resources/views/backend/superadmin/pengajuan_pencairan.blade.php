        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active  " href="{{route('superadmin_pengajuan_pencairan')}}" >
                    ...
                    <div class="col-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><small><b>Tanggal Pengajuan</b></small></th>
                                <th><small><b>Total Penjualan</b></small> </th>
                                <th><small><b>Total Pencairan</b></small> </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($pengajuan_pencairan as $index=>$datas)
                                <tr>

                                    <td>{{ $index+1 }}</td>
                                    <td>{{ $datas->nama_umkm }}</td>
                                    <td>{{ $datas->tanggal_pengajuan }}</td>
                                    <td>{{ $datas->total_penjualan }}</td>
                                    <td>{{ $datas->total_ppencarian }}</td>
                            </tr>
                            @endforeach
                        </tbody>

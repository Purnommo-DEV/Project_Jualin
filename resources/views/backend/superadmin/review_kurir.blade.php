        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active " href="{{route('superadmin_review_kurir')}}" >
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Review Kurir</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><small><b>Nama Kurir</b></small></th>
                                <th><small><b>Penjual</b></small></th>
                                <th><small><b>Nama Barang</b></small> </th>
                                <th><small><b>Pembeli</b></small> </th>
                                <th><small><b>Plat Motor</b></small> </th>
                                <th><small><b>Rating</b></small> </th>
                                <th><small><b>Review dari Pembeli</b></small> </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($review_kurir as $index=>$datas)
                                <tr>

                                    <td>{{ $index+1 }}</td>
                                    <td>{{ $datas->nama_kurir }}</td>
                                    <td>{{ $datas->penjualan }}</td>
                                    <td>{{ $datas->nama_barang }}</td>
                                    <td>{{ $datas->pembeli }}</td>
                                    <td>{{ $datas->plat_motor }}</td>
                                    <td>{{ $datas->rating }}</td>
                                    <td>{{ $datas->review_dari_pembeli }}</td>
                            </tr>
                            @endforeach
                        </tbody>

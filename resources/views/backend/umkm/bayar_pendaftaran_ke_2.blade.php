...
@section('content')
     <div class="container">
        <div class ="row">
            <div class ="col-4"></div>
            <div class ="col-4">
                   <center><h4>Selesaikan pembayaran dalam</h1></h4>
                   <center><h4 id="time">05:00</h4></center>
                          <h3>Batas akhir pembayaran</h2>
                            <h5>Selasa, 16 Maret 2021</h5>
                              <h4>Total Biaya</h4>
                               <h5>Rp 60.000,-</h5>
                                    <center>{!!$qrcode!!}</center><br>
                                    <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#modalPembayaran"> Bayar Sekarang</button><br><br>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend_save_pembayaran') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group ">
                <input type="hidden" name="username"
                    value="{{ $LoggedUserInfo['username'] }}"
                    class="form-control">
                <input type="hidden" name="email"
                    value="{{ $LoggedUserInfo['email'] }}"
                    class="form-control">
                <input type="hidden" name="jabatan"
                    value="{{ $LoggedUserInfo['jabatan'] }}"
                    class="form-control">
                <input type="hidden" name="nominal_bayar" value="60000"
                    class="form-control">
                <div class="form-group">
                    <input name="foto_bukti" type="file">
                </div>
            </div>
      </div>
    ...
    {{-- <div class ="container">
        <div class ="row">
            ...
            <div class ="col-sm-6">
                <center><b>Selesaikan Pembayaran</b></center>
                <center>
                    <div class ="row">
                        <div class ="col-3" id ="hour">24</div>
                        <div class ="col-1"></div>
                        <div class ="col-3" id ="minute">0</div>
                        <div class ="col-1"></div>
                        <div class ="col-3" id ="second">0</div>
                    </div>
                </center>
            </div>
            <div class ="col-sm-3">
                                    <form action="{{ route('backend_save_pembayaran') }}"
                                        method="post">
                                        @csrf
                                        <div class="form-group ">
                                            <input type="hidden" name="username"

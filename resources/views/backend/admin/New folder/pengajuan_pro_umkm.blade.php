...
@extends('backend.admin.layout.datatable_header')
    @section('title','Pengajuan Premium produk')
@endif
@section('content')
<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('backend_admin_pengajuan_pro_umkm')}}" >
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Pengajuan Premium UMKM</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin_dashboard')}}">Dasboard</a></li>
                            <li class="breadcrumb-item active"><a href="{{route('backend_admin_pengajuan_pro_umkm')}}"> Pengajuan Premium UMKM</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Pengajuan Premium UMKM</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                        ...
                        <tbody>
                            @foreach($pengajuan_pro_umkm as $index=>$datas)
                                <tr>
                                    ...
                                    @if($datas->status_pembayaran=="Telah Di Verifikasi")
                                            <button type="button" value="{{ $datas->id }}"
                                                class="btn btn-primary btnPengajuan btn-sm">Telah Di Verifikasi</button>
                                    @else
                                            <button type="button" value="{{ $datas->id }}"
                                                class="btn btn-danger btnPengajuan btn-sm">Belum Di Verifikasi</button>
                                    </td>
                                    @endif
                                </tr>
                            @endforeach
    ...
    <!-- /.content-wrapper -->
<div class="modal fade" id="editPengajuan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('update_pengajuan_akun_premium') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('backend_admin_managemen_user')}}" >
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href ="{{route('backend_admin_managemen_user')}}">Managemen User</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <tbody>
                            @foreach($user_pengguna as $index=>$datas)
                                @if($datas->jabatan == "umkm" or $datas->jabatan == "user")
                                <tr>

        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active " href="{{route('superadmin_laporan_income')}}" >
                            <i class="far fa-clipboard m-1"></i>
                            <p>
                                Laporan Income
                            </p>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Laporan Income</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Laporan Income</h3>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{route('superadmin_cetak_cetak_laporan_income')}}" class="float-right">
                        ...
                        <tbody>
                            @foreach($laporan_income as $index=>$datas)
                                <tr>

                                    <td>{{ $index+1 }}</td>
                                    <td>{{ $datas->laba_kotor }}</td>
                                    <td>{{ $datas->laba_operasi }}</td>
                                    <td>{{ $datas->laba_sebelum_pajak }}</td>
                                    <td>{{ $datas->laba_operasis }}</td>
                                    <td>{{ $datas->laba_operasi_berjalan }}</td>
                                    <td>{{ $datas->laba_bersih }}</td>
                            </tr>
                            @endforeach
                        </tbody>

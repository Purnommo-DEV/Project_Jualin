...
@section('title','Biaya Pengajuan Akun Premium')
@section('content')
     <div class="container">
      <div class="rumus1">
       ...
       <div class="rumus2">
         <h2>Batas akhir pembayaran</h2>
       </div>
       <div class="rumus3">
         <h3>Selasa, 16 Maret 2021</h3>
       </div>
       <div class="rumus4">
         <h4>Total Biaya</h4>
       </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend_save_pengajuan_akun_premium') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group ">
                <input type="hidden" name="umkm" value="{{$LoggedUserInfo['umkm']}}" class="form-control">
            </div>
            <div class="form-group ">
